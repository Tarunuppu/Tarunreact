  ...
  async function handlebutton(e) {
    ...
    await axios
      ...
      .then((response) => {
        ...
        axios
          .get("http://localhost:8000/api/get-users", config)
          .then((response) => {
  ...
  return (
    <div className="FilteroptionsDiv">
      <form className="Filteroptionsform" onSubmit={handlesubmit}>
        ...
        <p>
          For arranging the records in increasing order or decreasing order
        ...
        <input className="FilteroptionsSubmit" type="submit" />
      </form>
      {temp ? (
        <p>loading...</p>
      ) : (
